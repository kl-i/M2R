...
\newcommand{\ohat}{\hat{\oplus}}
\newcommand{\bigohat}{\hat{\bigoplus}}
\newcommand{\dual}[1]{#1^\diamond}
...
\begin{document}
\title{Notes on \dots}
\author{Ken Lee, Cyclic Group 69}
\date{Date}
\maketitle
...
Conventions : 
\begin{itemize}
  \item[--] ``Rings'' refer to commutative rings with unity. 
  \item[--] $\N$ denotes the naturals, including zero.  
\end{itemize}
